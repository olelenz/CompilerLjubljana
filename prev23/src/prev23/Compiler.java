...
public class Compiler {
	...
	public static HashMap<String, String> cmdLineArgs = new HashMap<String, String>();
	...
	public static void main(String[] args) {
		try {
			...
			while (true) {
				...
				// Register allocation.
                RegAll regallTop;
                try (RegAll regall = new RegAll(Integer.decode(cmdLineArgs.get("--num-regs")))) {
                    regall.allocate();
                    regall.log();
                    regallTop = regall;
                }
                ...
                All all = new All();
                all.completeFunctions(regallTop);
                all.buildFile(Compiler.cmdLineArgValue("--dst-file-name"), regallTop);
